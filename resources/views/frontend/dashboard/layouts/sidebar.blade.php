            <div class="dashboard_sidebar">
                ...
                <ul class="dashboard_link">
                    <li><a class="active" href="{{ route('user.dashboard') }}"><i class="fas fa-tachometer"></i>User
                            Dashboard</a></li>
                    @if (Auth::user()->role == 'vendor')
                        <li><a class="active" href="{{ route('vendor.dashboard') }}"><i class="fas fa-tachometer"></i>
                    ...
                    @if (Auth::user()->role != 'vendor')
                        <li><a href="{{ route('user.become-a-vendor-request') }}"><i class="fal fa-gift-card"></i>
                                request to be a
                                vendor</a></li>
                    @endif
