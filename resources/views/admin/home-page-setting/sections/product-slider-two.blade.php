            ...
            <form action="{{ route('admin.products-slider-two') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            @php
                                $subCategories = App\Models\SubCategory::where('category_id', @$productCategorySectionTwo->main_category)->get();
                            @endphp
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            @php
                                $childCategories = App\Models\ChildCategory::where('sub_category_id', @$productCategorySectionTwo->sub_category)->get();
                            @endphp
