                    ...
                    <div class="form-group">
                        ...
                        <select name="category_id" id="" class="form-control main-category">
                            ...
                            @foreach ($categories as $category)
                                <option value="{{ $category->id }}" @selected(old('category_id', $category->id) == $product->category_id)>{{ $category->name }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                        ...
                        <select name="sub_category_id" id="" class="form-control sub-category">
                            ...
                            @if (isset($subCategories))
                                @foreach ($subCategories as $subCategory)
                                    <option value="{{ $subCategory->id }}" @selected(old('sub_category_id', $subCategory->id) == $product->sub_category_id)>
                        ...
                        <select name="child_category_id" id="" class="form-control child-category">
                            ...
                            @if (isset($childCategories))
                                @foreach ($childCategories as $childCategory)
                                    <option value="{{ $childCategory->id }}" @selected(old('sub_category_id', $childCategory->id) == $product->child_category_id)>
